          ...
          <div class="tab-content">
            ...
            <div id="supporters" class="container tab-pane fade">
              ...
              <ul>
                ...
                <li><b><a href="https://buymeacoffee.com/amitmerchant/c/14723827" target="_blank">Howard</a></b></li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="sound-buttons">
            ...
            <div class="sound-button" data-sound="suburban-street">
              <div>
            ...
            <div class="sound-button" data-sound="rain-on-leaves">
              <div>
                ...
                <span>Rain on Leaves</span>
              </div>
              <div class="volume-control">
                <input type="range" min="0" max="100" value="70" class="volume-slider" id="rain-on-leaves-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="thunder">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="70" class="volume-slider" id="thunder-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="waves">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="50" class="volume-slider" id="waves-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="fireside">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="60" class="volume-slider" id="fireside-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="crickets">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="70" class="volume-slider" id="crickets-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="singing-bowl">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="70" class="volume-slider" id="singing-bowl-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="train">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="65" class="volume-slider" id="train-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="white-noise">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="4" class="volume-slider" id="white-noise-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="keyboard">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="15" class="volume-slider" id="keyboard-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="wind-chimes">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="20" class="volume-slider" id="wind-chimes-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="clock">
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="30" class="volume-slider" id="clock-volume">
              </div>
            </div>

            <div class="sound-button" data-sound="ceiling-fan">
              <div>
              ...
              <div class="volume-control">
                <input type="range" min="0" max="100" value="80" class="volume-slider" id="ceiling-fan-volume">
              </div>
            </div>
            <div class="sound-button" data-sound="tuning-radio">
              <div>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M2 14C2 10.2288 2 8.34315 3.17157 7.17157C4.34315 6 6.22876 6 10 6H14C17.7712 6 19.6569 6 20.8284 7.17157C22 8.34315 22 10.2288 22 14C22 17.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.8284C2 19.6569 2 17.7712 2 14Z" stroke="#1b1b1d" stroke-width="1.5"></path> <path d="M5 11C5 9.89543 5.89543 9 7 9H17C18.1046 9 19 9.89543 19 11C19 12.1046 18.1046 13 17 13H7C5.89543 13 5 12.1046 5 11Z" stroke="#1b1b1d" stroke-width="1.5"></path> <path d="M9 17C9 17.8284 8.32843 18.5 7.5 18.5C6.67157 18.5 6 17.8284 6 17C6 16.1716 6.67157 15.5 7.5 15.5C8.32843 15.5 9 16.1716 9 17Z" stroke="#1b1b1d" stroke-width="1.5"></path> <path d="M15 11.5V13" stroke="#1b1b1d" stroke-width="1.5" stroke-linecap="round"></path> <path d="M13 17H18" stroke="#1b1b1d" stroke-width="1.5" stroke-linecap="round"></path> <path d="M6.5 6L15 2" stroke="#1b1b1d" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                <span>Tuning Radio</span>
              </div>
              <div class="volume-control">
                <input type="range" min="0" max="100" value="60" class="volume-slider" id="tuning-radio-volume">
              </div>
            </div>
          </div>
        </div>
  ...
  <div id="newFeatureModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title custom-modal-title">I'm working on a Deep Breathing Exercise tool</h4>
        </div>
        <div class="modal-body modal-container">
          <p>Buy me <a href="https://buymeacoffee.com/amitmerchant" target="_blank">12 coffees</a>, a collective goal, and I'll release a tool <b>to help you deep breathe</b> (along with rest of the tools) which has helped me a lot to combat my anxiety and de-stress in an effective way.</p>
          <img src="art/deep-breath-preview.png" alt="Buy me a coffee" style="width: 100%; border-radius: 10px;">
          <p style="margin-top: 10px;">This tool can also be used to unwind yourself after a long writing session.</p>
